...
const OrgDocStatus = () => {
    ...
    const handleDownloadReport = (base64, name) => {
        ...
        link.download = name || 'Organization_Verification_Report.pdf';
        document.body.appendChild(link);
        link.click();
        document.body.removeChild(link);
    };

    // Mock API call to fetch organization data
    const fetchOrganizationDetails = useCallback(async () => {
        ...
        const mockOrganization = {
            name: 'HealthFirst Organization',
            email: 'contact@healthfirst.org',
            verificationStatus: {
                orgLogo: 'Verified',
                orgBrochure: 'Received',
                legalDocument: 'Pending',
                taxDocument: 'Rejected',
                businessLicense: 'Verified',
                authorizedRepId: 'Pending',
            ...
            finalReport: {
                ...
                name: 'HealthFirst_Organization_Report'
            }
        };
