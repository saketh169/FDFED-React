          ...
          <div className="mt-6 mb-3 w-full max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="relative">
                ...
                <input id="adminKey" type="password" className={`${commonInputClasses} ${errors.adminKey ? 'border-red-500' : ''}`} placeholder="Enter Admin Key" required minLength="5" maxLength="20" />
